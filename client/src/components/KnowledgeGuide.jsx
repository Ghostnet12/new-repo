...
export default function KnowledgeGuide({ profile }) {
  ...
  return <section className="panel knowledge-panel">
    ...
    {topic==='astrology'&&<>
      <NatalChart chart={personal.natal}/><h3>A chart has more than one layer</h3><p>A planet describes a symbolic function, a sign describes a style, and a house describes an area of life. Aspects describe relationships between planetary positions. A complete interpretation brings these together; a Sun sign alone is only an introduction.</p>
      <Lesson title="What this site can calculate" text="With birth date, local time and birthplace, The Fold calculates ten planetary placements, rising and meridian angles, Whole Sign houses, apparent retrograde motion and major aspects. The Birth Chart section shows the positions and explains them. Date alone still supplies an approximate Sun sign. Current transits and minor bodies are not calculated."/>
