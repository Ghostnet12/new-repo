    ...
    <form onSubmit={event => { event.preventDefault(); onSubmit(); }} aria-busy={loading}>
      ...
      <details className="reading-options simplified-options">
        ...
        <div className="form-grid">
          ...
          <div className="full"><details className="birth-details"><summary>Add full birth-chart details</summary><NatalForm value={value} onChange={onChange} disabled={loading}/></details></div>
