...
export default function Support({onReviews}) {
 return <section className="panel fold-support" aria-labelledby="support-title">
  ...
  <p>The Fold is an independent creative project by David Northrop, free for everyone to use—and it will stay that way. Every card, every melody and every detail is part of a space built for a little reflection.</p>
