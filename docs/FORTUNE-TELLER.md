...
- A 4.8-second, three-stage performance (awakening, listening, inscription), followed by a floating paper-card entrance. Pending stages are cancelled on navigation. Reduced-motion visitors receive an immediate card without animation.
- The teller has a matching lighting variant with bright ruby-red eyes and a stronger violet ball glow; layered images preserve alignment across screen sizes. Gold/plum celestial artwork frames both the on-page card and its download.
